    ...
    <div class="min-h-screen min-w-screen bg-gray-100">
        <div>
            <header id="top" class="w-full flex flex-col sm:relative bg-white pin-t pin-r pin-l">
                <nav id="site-menu" class="flex flex-col sm:flex-row w-full justify-between items-center px-4 sm:px-6 py-1 bg-gradient-to-r from-[#60BAAD] to-[#60BAAD] shadow-lg mb-2 sm:shadow-none border-t-4 border-red-900 sticky top-0 z-50">
