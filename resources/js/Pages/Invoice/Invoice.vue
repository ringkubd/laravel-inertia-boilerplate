            ...
            <div class="card mt-1 min-vh-100">
                ...
                <div class="card-body" id="printme">
                    <table class="table table-secondary border-0 print:border-0">
                        ...
                        <tr rowspan="2" style="border: 2px solid rgb(128,128,128)!important; color: black!important; font-weight: 600">
                            <th :colspan="6+ (feeTypes != null ? feeTypes.length : 0)" class="total" style="text-align: center!important; border: 2px solid rgb(128,128,128)!important;">Total Amount</th>
