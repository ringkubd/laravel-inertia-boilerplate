                ...
                <div class="card-body table-responsive">
                    <table class="table table-secondary table-striped">
                        ...
                        <tr v-for="(invoice, index) in invoices.data">
                            ...
                            <td>
                                <Actions :can="{...can, delete: can.delete && !invoice.has_notesheet, update: can.update && !invoice.has_notesheet}" :delete-url="route('invoice.destroy', invoice.invoice_id)" :edit-url="route('invoice.edit', invoice.invoice_id)" :detail-url="route('invoice.show', invoice.invoice_id)"></Actions>
                            </td>
                        </tr>
                        </tbody>
                        <tfoot></tfoot>
