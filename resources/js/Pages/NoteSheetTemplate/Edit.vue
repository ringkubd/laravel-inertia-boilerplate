<template>
    <Head>
        <title>Edit Notesheet Template</title>
    </Head>
    <Authenticated>
        <template #header>
            <PageHeader>Edit Notesheet Template</PageHeader>
        </template>
        <template #default>
...
export default {
    ...
    methods: {
        submit() {
            this.$inertia.put(route('note_sheet_template.update', this.note_template.id), this.form);
        }
    }
}
</script>
