        ...
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="tucupampam" style="z-index: 100;">
                    ...
                    <p>Updated at 2022-05-01</p>
                    <p style="display: inline;"> Diploma Student.</p>
                    ...
                    <div style="display: inline;">
                        ...
                        <p style="display: inline;">
                            <span class="s1"> Diploma Student</span>
                        </p>
                        <p style="display: inline;">
                    ...
                    <ul class="ul1">
                        <li class="li8">
                        <span class="s1"><strong>Cookie:</strong> small amount of data generated by a website and saved by your web browser. It is used to identify your browser, provide analytics, remember information about you such as your language preference or login information.
                            <br>
                        </span>
                        </li>
                        <li class="li8">
                        <span class="s1">
                            ...
                            <a href="https://isdb-bisew.org">IsDB-BISEW</a>,
                            <a>IDB Bhaban (4th Floor) E/8-A, Rokeya Sharani, Sher-e-Bangla Nagar. Dhaka-1207, Bangladesh Phone: +880 2 9183006 Email: idbb@isdb-bisew.org Fax: +880 2 9183001 - 2</a>
                        ...
                        <span class="s1">
                            ...
                            where
                            <a href="https://isdb-bisew.org">Diploma Student</a>
                            or the owners/founders of
                            <a href="https://isdb-bisew.org">Diploma Student</a>
                            are based, in this case is
                            <a href="https://isdb-bisew.org">Bangladesh</a>.
                            <br>
                        </span>
                        </li>
                        <li class="li8">
                        ...
                        <span class="s1">
                            ...
                            any internet connected device such as a phone, tablet, computer or any other device that can be used to visit
                            <a href="https://isdb-bisew.org">Diploma Student</a>
                        ...
                        <span class="s1">
                            ...
                            <a href="https://isdb-bisew.org">Diploma Student</a> as described in the relative terms (if available) and on this platform.
                            <br>
                        </span>
                        </li>
                        <li class="li8">
                        ...
                        <span class="s1">
                            ...
                            <a href="https://isdb-bisew.org">Diploma Student</a>’s site, which can be accessed via this URL: <a href="https://diploma.isdb-bisew.org">___________</a>
                            <br>
                        </span>
                        </li>
                        <li class="li8">
                        <span class="s1">
                            ...
                            <a href="https://diploma.isdb-bisew.org">Diploma Student</a> to use the Services.<br>
                        </span>
                        </li>
                    </ul>
                    <p class="p9">
                    ...
                    <div>
                        ...
                        <span class="s1">There is some information like your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our platform. This information may be used to connect your computer to the Internet. Other information collected automatically   could be a login, e-mail address, password, computer and connection information such as browser plug-in types and versions and time zone setting, operating systems and platforms, purchase history, (we sometimes aggregate with similar information from other Users), the full Uniform Resource Locator (URL) clickstream to, through and from our Website that may include date and time; cookie number;
                            ...
                            This information is primarily needed to maintain the security and operation of our , and for our internal analytics and reporting purposes.
                        </span>
                        </p>
                    </div>
                    <p class="p12">
                    ...
                    <p class="p10">
                        <span class="s1">We also collect information from mobile devices for a better user experience, although these features are completely optional:</span>
                    </p>
                    <ul class="ul1"><!----> <!----> <!----> <!----></ul>
                    <p class="p3">
                        <br>
                    ...
                    <ul class="ul1">
                        ...
                        <li class="li11">
                            <span class="s3">To process transactions</span></li>
                        <li class="li11">
                    ...
                    <p class="p10">
                    <span class="s1">
                        We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming our customer, we receive information from a third party that provides automated fraud detection services to us.
                    ...
                    <p class="p10">
                    <span class="s1">We are incorporated in Bangladesh. Information collected via our website, through direct interactions with you, or from use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries
              that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans- border transfer and hosting of such information.
                    </span>
                    </p>
                    <p class="p3">
                        <br>
                    ...
                    <p class="p10">
                    <span class="s1">The rights you have to request updates or corrections to the information we collect depend on your relationship with us.
                    ...
                    <h1>Governing Law</h1>
                    <p class="p10">
                        <span class="s1">The laws of Bangladesh, excluding its conflicts of law rules, shall govern this Agreement and your use of our service. Your use of our service may also be subject to other local, state, national, or international laws.</span>
                    </p>
                    <p class="p3">
                        <br>
                    </p>
                    ...
                    <p class="p10">
                    <span class="s1">This Privacy Policy applies only to the Services.
                        The Services may contain links to other websites not operated or controlled by Diploma Student.
                    ...
                    <p class="p10">
                    <span class="s1">
                        We use "Cookies" to identify the areas of our website that you have visited. A Cookie is a small piece of data stored on your computer or mobile device by your web browser.
                    ...
                    <span class="s1">
                        ...
                        You can use the pixel to: Make sure your ads are shown to the right people.
                        Facebook pixel may collect information from your device when you use the service.
