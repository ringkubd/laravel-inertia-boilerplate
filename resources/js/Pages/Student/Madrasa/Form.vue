            ...
            <div class="card-body">
                <form action="" enctype="multipart/form-data" @submit.prevent="submitForm">
                    ...
                    <fieldset class="row form-group">
                        ...
                        <div class="row">
                            <div class="col-md">
                                <label for="classroom">Current Class</label>
                                <select name="classroom" id="classroom" v-model="form.classroom" class="form-control">
                                    <option :value="classroom.id" v-for="classroom in classes">{{classroom.name}}</option>
                                </select>
                                <div v-if="errors.classroom" class="text-danger">
                                    {{ errors.classroom }}
                                </div>
                            </div>
                            <div class="col-md">
...
export default {
    ...
    props: ['student', 'user', 'createForm', 'postForm', 'trade_polytechnic', 'trade_madrasa', 'academic_session', 'banks', 'selected_bank', 'selected_trade', 'selected_session', 'polytechnic', 'madrasa', 'errors', 'classes'],
    data(){
        return {
            form: useForm({
                ...
                classroom: this.student.classroom && this.student.classroom.length > 0 ? this.student.classroom[0].id : null,
