                ...
                <div class="card-body table-responsive">
                    <table class="table table-striped table-secondary">
                        ...
                        <tr v-for="(student,index) in students.data">
                            ...
                            <td>
                                {{ student.classroom.length > 0 ? student.classroom[0].name : "" }}
                            </td>
                            <td>
                                {{ student.class_roll }}
                            </td>
...
export default {
    ...
    methods: {
        ...
        filterData(){
            this.$inertia.replace(route('madrasa.student.index', { 'madrasah' : this.filterParam.madrasah, 'current_session': this.filterParam.session, 'trade': this.filterParam.trade, 'classroom': this.filterParam.classroom}))
        },
        changeMadrasah(){
